...
export class CalendarDialogComponent {
  ...
  constructor(
    ...
    this.options = new UntypedFormGroup({
      title: new FormControl(this.data?.event?.title || ''),
      color: new FormControl(this.data?.event?.color?.primary || ''),
      start: new FormControl(this.data?.event?.start || ''),
      end: new FormControl(this.data?.event?.end || '')
    });
  }
}
